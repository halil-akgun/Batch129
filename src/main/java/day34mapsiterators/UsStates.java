...
public enum UsStates {
    /*
    1- Enum bir data deposudur. Enum'in icine sabit, degisme ihtimali olmayan datalari koyariz.
    2- Mesela yilin aylari, Haftanin gunleri, ABD'nin eyaletleri, Honda icin yapilan App'lerde Crv, Accord class'lari enum'dir. vs vs vs
    3- Sabit datalari app'in icine gommek icin enum kullaniriz.
       App'ler stand alone (kendi basina ayakta durabilmesi icin) olmasi gerektigi icin sabit datalari app'in icine gomeriz.
    */
