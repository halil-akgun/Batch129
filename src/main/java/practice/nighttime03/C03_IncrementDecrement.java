...
///////// ****************************************** \\\\\\\\\\\\\\\\\\\\
        ...
        System.out.println("post-increment satırında" + sayı++); // 13 (önce yazdırır sonra arttırır)  ********
...
///////// ****************************************** \\\\\\\\\\\\\\\\\\\\
        ...
        System.out.println(sayı3++); // 12  (önce yazdırır sonra arttırır)

        System.out.println(--sayı2); // 9

        System.out.println(sayı3++); // 13  (önce yazdırır sonra arttırır)
